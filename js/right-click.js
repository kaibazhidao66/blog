        ...
        init: function(options) {
            ...
            $this.each(function(i) {
                ...
                function(e) {
                    ...
                    if(top<0) top=0;
                    if(bodyHe-Coords.clientY<112.5) top=bodyHe-225;
                    if(left<0) left=0;
                    if($('body')[0] === e.target){if(bodyWi-Coords.clickX<112.5) left=bodyWi-225} else {if(bodyWi-Coords.clientX<112.5) left=bodyWi-225};
					//防止菜单超出可见区域，不需要可注释掉
                    $menu.css({
                        top: top + 'px',
                        left: left + 'px',
